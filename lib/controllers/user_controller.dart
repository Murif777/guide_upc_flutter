...
class UserController {
  ...
  }) : _speechService = speechService, _userService = userService;
  ...
  Future<void> checkFirstTimeUser(VoiceProvider voiceProvider) async {
    try {
      ...
      if (storedName != null) {
        ...
        String welcomeText = "Bienvenido $_userName. ¿Qué te gustaría hacer hoy?";
  ...
  Future<void> saveName(String nameToSave, VoiceProvider voiceProvider, BuildContext context) async {
    ...
    try {
      ...
      String welcomeText = "Hola $_userName, bienvenido a guide UPC, una aplicacion en la que podras: "
  ...
  void requestHelp(VoiceProvider voiceProvider) {
    const helpText = "No te preocupes y mantén la calma, la ayuda está en camino a tu ubicación.";
  ...
  void _speakWithStateTracking(String text, VoiceProvider voiceProvider) {
    ...
    _speechService.speakText(text, () {
      debugPrint("Callback específico ejecutado, estableciendo isSpeaking a false");
